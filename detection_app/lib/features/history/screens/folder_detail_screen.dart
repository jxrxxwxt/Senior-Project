...
class _FolderDetailScreenState extends State<FolderDetailScreen> {
              ...
              TextButton.icon(
                ...
                icon: Icon(
                    ...
                    color: provider.isSelectionMode
                        ? Colors.red
                        : AppColors.textGrey),
                label: Text(provider.isSelectionMode ? "Cancel" : "Select",
                    style: TextStyle(
                        color: provider.isSelectionMode
                            ? Colors.red
                            : AppColors.textGrey,
  ...
  Widget _buildItemCard(
      BuildContext context, HistoryItem item, HistoryProvider provider) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: isSelected ? Colors.blue : const Color(0xFFEDF1F7),
